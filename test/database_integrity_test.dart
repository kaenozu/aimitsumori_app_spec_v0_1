...
void main() {
  ...
  test(
    'updating a project preserves requirements and revision history',
    () async {
      ...
      final requirements = await requirementRepository.getRequirements(
        'project-1',
      );
      final revisions = await revisionService.getProjectRevisions('project-1');
      expect(
        requirements
            .singleWhere((value) => value.categoryId == 'drainage')
            .priority,
  ...
  test(
    'quote and revision are rolled back together when revision insert fails',
    () async {
